        ...
        if first_name is None:
            ...
            if isNameValid(first_name):
                ...
                if last_name is not None:
                    ...
                    list_of_users=PhoneDirectory.objects.filter(name_list__icontains=first_name)|PhoneDirectory.objects.filter(name_list__icontains=last_name)
                else:
                    list_of_users=PhoneDirectory.objects.filter(name_list__icontains=first_name)
